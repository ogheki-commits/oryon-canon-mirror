...
- Pour le **visage, la coiffure, les couleurs, la silhouette, la taille apparente relative, les traits raciaux visibles, les proportions générales et la tenue représentée**, la nouvelle image correspondante est prioritaire.
- **Toutes les anciennes références visuelles correspondantes sont obsolètes et ne doivent plus être utilisées.**
...
| Personnage canonique | Fichier source actuel | Statut |
|---|---|---|
...
| Elfa Elyndra | `Elfa.jpg` | Référence visuelle actuelle — corps entier |
| Elza Blood | `Elza.jpg` | Référence visuelle actuelle — corps entier |
| Enjin Etio | `Enjin.jpg` | Référence visuelle actuelle — corps entier ; cigarette canonique |
| Eren Enma | `Eren.jpg` | Référence visuelle actuelle — corps entier |
| Hetsuga Eno | `Hetsuga.jpg` | Référence visuelle actuelle — corps entier |
| Lyra Enma | `Lyra.jpg` | Référence visuelle actuelle — corps entier |
| Mina Khardûn | `Mina.png` | Référence visuelle actuelle — corps entier |
| Nava Asteria | `Nava.png` | Référence visuelle actuelle — corps entier |
| Nina Neko | `Nina.png` | Référence visuelle actuelle — corps entier |
| Norn Khardûn | `Norn.jpg` | Référence visuelle actuelle — corps entier |
| Râ | `Râ.png` | Référence visuelle actuelle — corps entier |
| Sato Elio | `Sato.jpg` | Référence visuelle actuelle — corps entier |
| Trya Belion | `Trya.jpg` | Référence visuelle actuelle — corps entier |
| Vely Flower | `Vely.jpg` | Référence visuelle actuelle — corps entier |
| Vrul Tesyl | `Vrul.png` | Référence visuelle actuelle — corps entier |
| Yoh Shuzo | `Yoh.jpg` | Référence visuelle actuelle — corps entier |
| Zeo Soul — correspondance probable | `Zao.png` | Référence visuelle actuelle — corps entier ; **nom de fichier “Zao” à confirmer comme Zeo** |
| Zenedia Aroul | `Zenedia.png` | Référence visuelle actuelle — corps entier |

## Consigne d’utilisation

- Avant toute scène où un personnage apparaît visuellement de manière importante, utiliser **ce nouveau jeu complet**, pas les anciennes illustrations.
